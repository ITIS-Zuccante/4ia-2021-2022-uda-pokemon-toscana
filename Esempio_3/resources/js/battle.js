import { getPokemon, getGigantaMax } from "./main.js";
...
(() => {
  ...
  _TEAMS = {
    teamAlfa: {
      teamName: JSON.parse(window.localStorage.getItem('teamsChose')).teamAlfa,
      pokemons: JSON.parse(window.localStorage.getItem(JSON.parse(window.localStorage.getItem('teamsChose')).teamAlfa)).pokemons,
      normal: 3,
      super: 2,
      hyper: 1
    },
    teamBeta: {
      teamName: JSON.parse(window.localStorage.getItem('teamsChose')).teamBeta,
      pokemons: JSON.parse(window.localStorage.getItem(JSON.parse(window.localStorage.getItem('teamsChose')).teamBeta)).pokemons,
      normal: 3,
      super: 2,
      hyper: 1
    }
